  ...
  $(".platforms button").click(function () {
    ...
    setTimeout(function () {
      ...
      setTimeout(function () {
        ...
        setTimeout(function () {
          $(".loader-text-wrapp .text").html(
            '<span class="text-success">' + username + " verified!</span>"
          );
          setTimeout(function () {
            $(".loader-text-wrapp .text").html(
...
var generateTemplate = function () {
  ...
  html =
    '<div class="col-12 col-sm-6 col-md-4 col-lg-4 single-act mb-4 animated bounceIn">';
  ...
  html +=
    '<img src="https://images.squarespace-cdn.com/content/v1/5f25fcd0e5db813a8d2eb9eb/1597852444367-316R8PBPTWAPIQXROSC0/coin+logo.png" width="30" class="vc_coin-icon-sm"> <span>' +
    coinNums[coinNum] +
    " CP</span>";
  html += "</div>";
...
$("#generate_btn").click(function () {
  ...
  audioElement.play();
  $(".preloader").show();
  $("header, nav, main, footer").css(
    "filter",
    "blur(5px) contrast(0.8) brightness(0.8)"
  );
  var u = $('input[name="username"]').val();
  setTimeout(function () {
    $(".preloader .p-text").html(
      '<span class="text-success">Connected successfully!</span>'
    );
    ...
    setTimeout(function () {
      ...
      setTimeout(function () {
        $(".preloader .p-text").html(
          '<span class="text-success">' + u + " verified!</span>"
        );
